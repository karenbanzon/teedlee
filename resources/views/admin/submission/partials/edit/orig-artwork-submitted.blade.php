<div class="alert alert-info">
    ...
    <p>
        ...
        <a href="{!! url('users/'.$submission->user_id.'/'.$submission->id.'.orig.psd') !!}"
           class="btn btn-sm btn-primary"><i class="fa fa-download"></i> Download artwork
        </a>

<!--        <a href="{!! url('admin/submission/promote/'.$submission->id.'/orig_artwork_resubmit') !!}"
           class="btn btn-sm btn-warning"><i class="fa fa-refresh"></i> Request for resubmission
        </a>-->

<!--        <a href="#" class="btn btn-sm btn-sm btn-danger pull-right" id="decline">
