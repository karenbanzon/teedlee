                    ...
                    <div class="box-body">
                        ...
                        <div id="draft-images" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                @foreach($submission->images as $index => $image)
                                    <div class="item cover {!! $index==0 ? 'active' : null !!}" style="background-image: url({!! $image->path !!}); height: 400px;">
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <b>Status</b> <a class="pull-right">{!! title_case(str_replace('_',' ',$submission->status)) !!}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Orig Artwork</b> <a class="pull-right">None</a>
                            </li>
                        </ul>
                    </div>
                    <div class="clr"></div>
                ...
                @elseif( strpos($submission->status, 'internal_voting') !== false || $submission->status == 'awaiting_orig_artwork' )
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="direct-chat-messages">
                                <div class="direct-chat-msg {!! $index % 2 == 0 ? 'left' : 'right' !!}">
                                    ...
                                    <!-- /.direct-chat-info -->
                                        <img class="direct-chat-img" src="{!! $vote->user->avatar !!}" alt="Message User Image"><!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                        {!! str_repeat('<span class="fa fa-star text-yellow"></span>', $vote->rating) !!}
                                        {!! $vote->comment !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            @if( !$has_voted )
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" min="1" max="5" class="form-control" name="rating" value="3" placeholder="Rating">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="box-footer text-bold">
                            Average Rating: {!! str_repeat('<span class="fa fa-star text-yellow"></span>', $rating/($index+1)) !!} ({!! round($rating/($index+1), 2) !!})
                        </div>
                        <div class="clr"></div>
                    </div>
                @endif
