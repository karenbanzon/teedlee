<section class="row expanded" id="main-slider">
    <div class="small-12 slides-container" style="width: 100%; height: 800px; padding: 0;">
        <div id="slides">
            <ul class="slides-container">
                <li>
                    {!! Html::image('images/hero_slide_1.jpg', '', ['width' => "1280"]) !!}
                </li>
                <li>
                    {!! Html::image('images/hero_slide_2.jpg', '') !!}
                </li>
                <li>
                    {!! Html::image('images/hero_slide_3.jpg', '') !!}
                </li>
                <li>
