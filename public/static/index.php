...
<html>
	...
	<body>
		...
		<section class="row">
			...
			<div class="background-subtle text-center small-12 columns">
				.small-12
			</div>
			<div class="background-neutral text-center text-white small-12 medium-8 columns">
				.small-12 .medium-8
			</div>
			<div class="background-subtle text-center small-4 medium-6 columns">
				.small-4 .medium-6
			</div>
			<div class="background-neutral text-center text-white small-4 medium-6 columns">
				.small-4 .medium-6
			</div>
			<div class="background-subtle text-center small-4 medium-6 columns">
				.small-4 .medium-6
			...
			<div class="background-subtle text-center small-3 medium-6 columns columns">
				.small-3 .medium-6 .columns
			</div>
			<div class="background-neutral text-center text-white small-3 medium-6 columns columns">
				.small-3 .medium-6 .columns
			</div>
			<div class="background-subtle text-center small-3 medium-6 columns columns">
				.small-3 .medium-6 .columns
		...
		<section class="row">
			...
			<div class="small-8 small-offset-2">
				<hr>
				<p><strong>Forms appear everywhere.</strong> Make sure you use them consistently and in the proper context</p>
				<hr>
			</div>
			<div class="small-12 medium-8 medium-offset-2">
				<h4>Block Forms</h4>
				...
				<form>
					...
					<div class="form-field inline">
						<div class="form-entry">
							<button type="submit" class="submit white">Submit</button>
						</div>
					</div>
				</form>
			</div>
					...
					<div class="card-container">
						<div class="card-body">
							<div class="text-center padding-10">
								<span class="h1 icon icon-menu"></span>
								<code class="display-block padding-top-10 text-yellow">.icon-menu</code>
							</div>
							<p><small>Call this icon with this code:</small></p>
							<pre><code>&lt;span class="icon icon-menu"&gt;&lt;/span&gt;</span></code></pre>
						</div>
					</div>
				</div>
				<div class="card small-8 small-offset-2 medium-6 medium-offset-0">
